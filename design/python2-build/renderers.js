...
renderers.home=function(){
  ...
  var nc=nextChapter();
  var h='<div class="kick">PYTHON</div><div class="h1">Python 学院</div>'
    +'<div class="sub">浏览器里写代码 · 进度 '+s.doneC+'/'+s.totalC+' 章</div>';
  ...
  h+='<div class="tutor-card"><img class="tutor-photo" alt="导读人" src="TUTOR_IMG_PLACEHOLDER">'
    +'<div class="tutor-body"><div class="tutor-cap">导读人 · 拉里·佩奇</div>'
    +'<div class="tutor-quote">'+pick(TUTOR_QUOTES)+'</div>'
    +'<div class="tutor-name">把「让 Google 跑起来」的语言教给你</div></div></div>';
  return h;
};
var TUTOR_QUOTES=[ '「别怕麻烦。装环境是每个程序员的成人礼，卡住了就来找我。」', '「可读性是 Python 的第一信条：代码是写给人看的。」', '「先让它跑起来，再让它漂亮。」', '「变量的名字，是程序员的尊严。」', '「函数把复杂藏起来，把简单交出去。」', '「Print 是第一行魔法：让机器回你一句话。」' ];
...
renderers.mine=function(){
  ...
  h+='<div class="card" style="display:flex;align-items:center;gap:14px;border-radius:var(--r-l)">'
    ...
    +'<div style="min-width:0;flex:1"><b style="font-size:18px">Python 学徒</b><div style="font-size:13px;color:var(--ink2);margin-top:2px;line-height:1.5;min-width:0">'+rk.name+' · 已学 '+s.doneC+'/'+s.totalC+' 章 · 小卷 '+s.examFull+' 份</div>'
...
renderers.about=function(){
  return '<div class="kick">ABOUT</div><div class="h1">关于学院</div>'
    +'<div class="sub">Python 学院 · 样张真版 '+APP_VER+'</div>'
    +'<div class="card" style="border-radius:var(--r-l)"><div class="lesson-body"><p>以「对齐样张 v2」为界面底座（iOS 26 玻璃语汇），接入 <b>Python 学院真实内容引擎</b>：36 章讲义、随堂判题、章节结算、小卷、错题池、称号徽章与跨院打卡，全部读写线上同款存储键。</p>'
...
renderers.author=function(){
  return '<div class="kick">BACKSTAGE</div><div class="h1">作者与幕后</div>'
    ...
    +'接着 C 语言学院（浏览器里真编译真运行）、Python 学院（读透《芯片战争》）陆续加入。<br>'
