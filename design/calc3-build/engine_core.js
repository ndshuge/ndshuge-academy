...
/* ---------- 称号 / 徽章 / 统计 ---------- */
var RANKS = [[0,'初入书院'],[3,'函数学徒'],[7,'三角见习'],[12,'极限行者'],[18,'连续卫士'],[25,'求导剑客'],[33,'链式法师'],[42,'中值骑士'],[52,'最优化匠人'],[62,'积分炼金师'],[72,'反常探测者'],[80,'级数大师'],[87,'泰勒学士'],[93,'幂级数贤者'],[97,'复分析术士'],[100,'笛卡尔传人']];
...
var BADGES=[
  {n:'开卷第一',d:'完成第 1 章',c:function(s){ return s.doneC>=1; }},
  {n:'函数学徒',d:'完成第一部分 · 达第 5 章',c:function(s){ return s.doneC>=5; }},
  {n:'极限行者',d:'完成第二部分 · 达第 10 章',c:function(s){ return s.doneC>=10; }},
  {n:'求导剑客',d:'完成第三部分 · 达第 15 章',c:function(s){ return s.doneC>=15; }},
  {n:'链式法师',d:'完成第四部分 · 达第 20 章',c:function(s){ return s.doneC>=20; }},
  {n:'积分炼金师',d:'完成第五部分 · 达第 25 章',c:function(s){ return s.doneC>=25; }},
  {n:'级数大师',d:'完成第六部分 · 全书 30 章通关',c:function(s){ return s.doneC>=30; }},
