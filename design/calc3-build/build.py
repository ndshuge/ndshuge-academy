...
CHIP    = os.path.join(os.path.dirname(DESIGN), 'calculus.html')
OUT     = os.path.join(DESIGN, 'calc3-真版-预览.html')
...
new = new.replace('<title>芯片学院 · 对齐样张 v2（iOS 26 玻璃语汇）</title>',
                  '<title>微积分学院 · 大一高数</title>')
new = new.replace('<b id="brandName">芯片战争学院</b><span>CHIP WAR ACADEMY</span>',
                  '<b id="brandName">微积分学院</b><span>CALCULUS ACADEMY</span>')
