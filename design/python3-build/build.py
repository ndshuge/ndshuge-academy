...
CHIP    = os.path.join(_HERE, '_chapters_v2.js')
OUT     = os.path.join(DESIGN, 'python3-v2-真版-预览.html')
...
new = new.replace('<title>芯片学院 · 对齐样张 v2（iOS 26 玻璃语汇）</title>',
                  '<title>Python 学院 · 编程入门</title>')
new = new.replace('<b id="brandName">芯片战争学院</b><span>CHIP WAR ACADEMY</span>',
                  '<b id="brandName">Python 学院</b><span>PYTHON ACADEMY</span>')
