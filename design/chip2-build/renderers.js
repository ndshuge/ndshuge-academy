...
renderers.about=function(){
  return '<div class="kick">ABOUT</div><div class="h1">关于学院</div>'
    +'<div class="sub">芯片战争学院 · 样张真版 '+APP_VER+'</div>'
    +'<div class="card" style="border-radius:var(--r-l)"><div class="lesson-body"><p>以「对齐样张 v2」为界面底座（iOS 26 玻璃语汇），接入 <b>芯片战争学院真实内容引擎</b>：36 章讲义、随堂判题、章节结算、小卷、错题池、称号徽章与跨院打卡，全部读写线上同款存储键。</p>'
    +'<p>按压反馈走 iOS 高亮语言、桌面细滚动条、页面推入转场、30 分钟参考计时与结算动画均沿用样张。</p></div></div>';
};
